...
Public Class SLFLSTP004
    ...
    '=　定数定義
    '============================================================================================================================
    Private Const M_DISP_ID As String = P_FUN_SLF & P_SCR_LST & P_PAGE & "004"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        '表設定
        pfSet_GridView(Me.grvList, "SLFLSTP004", "SLFLSTP004_Header", Me.DivOut, "L", 40)
...
'                btnUpdate.Enabled = False
    ...
    Protected Sub grvList_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles grvList.RowCommand
        ...
        Select Case e.CommandName
            Case "btnSelect"
                ...
                Me.txtDealDtl2.ppText = CType(rowData.FindControl("対応結果フリー入力"), Label).Text.Replace("<br />", "")
    ...
    Private Function mfGet_Data(ByRef cpobjWKDS As DataSet) As Boolean
        ...
        If clsDataConnect.pfOpen_Database(conDB) Then
            Try
                cmdDB = New SqlCommand("SLFLSTP004_S1", conDB)
                cmdDB.Parameters.Add(pfSet_Param("TBOXID", SqlDbType.NVarChar, DirectCast(ViewState("TBOXID"), String))) 'TBOXID
                cmdDB.Parameters.Add(pfSet_Param("DATEFROM", SqlDbType.NVarChar, DirectCast(ViewState("DATEFROM"), String)))
                cmdDB.Parameters.Add(pfSet_Param("DATETO", SqlDbType.NVarChar, DirectCast(ViewState("DATETO"), String)))
                'リストデータ取得
...
'                Master.ppLeftButton1.Visible = True
    ...
    Private Function mfGet_Session()
        ...
        'セッションからキー項目取得
        strKey = DirectCast(Session(P_KEY), String())
        ...
        ViewState("DATEFROM") = strKey(1)
        ViewState("DATETO") = strKey(2)
