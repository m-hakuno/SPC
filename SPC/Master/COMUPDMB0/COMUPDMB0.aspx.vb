...
#Region "定数定義"
    ...
    Const DispCode As String = "COMUPDMB0"                  '画面ID
    Const MasterName As String = "機器種別マスタ"           '画面名
    Const DBSName As String = "SPCDB.dbo."                  'DB名.スキーマ名
    Const TableName As String = "MB0_APPACLASS"        'テーブル名
...
#Region "グリッドビュー制御"
    ...
    Private Sub grvList_DataBound(sender As Object, e As EventArgs) Handles grvList.DataBound
        ...
        For Each rowData As GridViewRow In grvList.Rows
            If CType(rowData.FindControl("CMB0_DELETE_FLG"), TextBox).Text = "1" Then
    ...
    Private Sub grvList_RowCommand(sender As Object, e As CommandEventArgs) Handles grvList.RowCommand
        ...
        Try
            If e.CommandName = "Select" Then
                ...
                '★ロックテーブルキー項目の登録
                arKey.Insert(0, CType(rowData.FindControl("CMB0_APPACLASS_CD"), TextBox).Text)
                arKey.Insert(0, CType(rowData.FindControl("CMB0_APPA_CLS"), TextBox).Text)
                ...
                '編集エリアに値を設定
                Me.ddlAPPACLASS_CD.ppSelectedValue = CType(rowData.FindControl("CMB0_APPACLASS_CD"), TextBox).Text
                Me.txtAPPA_CLS.ppText = CType(rowData.FindControl("CMB0_APPA_CLS"), TextBox).Text
                Me.txtAPPACLS_NM.ppText = CType(rowData.FindControl("CMB0_APPACLS_NM"), TextBox).Text
                Me.txtAPPACLS_SNM.ppText = CType(rowData.FindControl("CMB0_SHORT_NM"), TextBox).Text
                Me.ddlSEARIAL_CLS.ppDropDownList.SelectedValue = CType(rowData.FindControl("CMB0_SEARIAL_CNTL_CLS"), TextBox).Text
                Me.htxtDELETE.Value = CType(rowData.FindControl("CMB0_DELETE_FLG"), TextBox).Text
                If CType(rowData.FindControl("CMB0_DELETE_FLG"), TextBox).Text = "0" Then
                    Master.ppBtnDelete.Text = "削除"
                ...
                Else
                    ...
                    'Master.ppMainEnabled = False
                End If
                ViewState("ddlAPPACLASS_CD") = CType(rowData.FindControl("CMB0_APPACLASS_CD"), TextBox).Text
                ViewState("txtAPPA_CLS") = CType(rowData.FindControl("CMB0_APPA_CLS"), TextBox).Text
                ViewState("txtAPPACLS_NM") = CType(rowData.FindControl("CMB0_APPACLS_NM"), TextBox).Text
                ViewState("txtAPPACLS_SNM") = CType(rowData.FindControl("CMB0_SHORT_NM"), TextBox).Text
                ViewState("ddlSEARIAL_CLS") = CType(rowData.FindControl("CMB0_SEARIAL_CNTL_CLS"), TextBox).Text
                ViewState("htxtDELETE") = CType(rowData.FindControl("CMB0_DELETE_FLG"), TextBox).Text
...
#Region "そのほかのプロシージャ"
    ...
    Private Sub msGet_Data()
        ...
        Try
            ...
            objSQLCmd.CommandText = "COMUPDMB0_S1"
    ...
    Private Sub msEditData(ByVal ipmstrDispMode As String)
        ...
        Select Case ipmstrDispMode
            Case "INSERT"
                MesCode = "00003"
                strStored = "COMUPDMB0_I1"
            Case "UPDATE"
                MesCode = "00001"
                strStored = "COMUPDMB0_U1"
            Case "DELETE"
                Select Case Master.ppBtnDelete.Text
                    Case "削除"
                        MesCode = "00002"
                        strStored = "COMUPDMB0_U2"
                        getFlg = "1"
                    Case "削除取消"
                        MesCode = "00001"
                        strStored = "COMUPDMB0_U2"
        ...
        Try
            ...
            objSQLCmd.Parameters.Add("prmMB0_APPACLASS_CD", SqlDbType.NVarChar)
            objSQLCmd.Parameters.Add("prmMB0_APPA_CLS", SqlDbType.NVarChar)
            ...
            End If
            objSQLCmd.Parameters("prmMB0_APPACLASS_CD").Value = strwkBuff
            ...
            End If
            objSQLCmd.Parameters("prmMB0_APPA_CLS").Value = strwkBuff

            Select Case ipmstrDispMode
                Case "INSERT"
                    objSQLCmd.Parameters.Add("prmMB0_APPACLS_NM", SqlDbType.NVarChar)
                    objSQLCmd.Parameters.Add("prmMB0_SHORT_NM", SqlDbType.NVarChar)
                    objSQLCmd.Parameters.Add("prmMB0_DELETE_FLG", SqlDbType.NVarChar)
                    objSQLCmd.Parameters.Add("prmMB0_INSERT_USR", SqlDbType.NVarChar)
                    objSQLCmd.Parameters.Add("prmMB0_SEARIAL_CNTL_CLS", SqlDbType.NVarChar)
                    ...
                    End If
                    objSQLCmd.Parameters("prmMB0_APPACLS_NM").Value = strwkBuff
                    ...
                    End If
                    objSQLCmd.Parameters("prmMB0_SHORT_NM").Value = strwkBuff

                    objSQLCmd.Parameters("prmMB0_DELETE_FLG").Value = "0"
                    objSQLCmd.Parameters("prmMB0_INSERT_USR").Value = User.Identity.Name
                    ...
                    End If
                    objSQLCmd.Parameters("prmMB0_SEARIAL_CNTL_CLS").Value = strwkBuff

                Case "UPDATE"
                    objSQLCmd.Parameters.Add("prmMB0_APPACLS_NM", SqlDbType.NVarChar)
                    objSQLCmd.Parameters.Add("prmMB0_SHORT_NM", SqlDbType.NVarChar)
                    objSQLCmd.Parameters.Add("prmMB0_DELETE_FLG", SqlDbType.NVarChar)
                    objSQLCmd.Parameters.Add("prmMB0_UPDATE_USR", SqlDbType.NVarChar)
                    objSQLCmd.Parameters.Add("prmMB0_SEARIAL_CNTL_CLS", SqlDbType.NVarChar)
                    ...
                    objSQLCmd.Parameters("prmMB0_DELETE_FLG").Value = "0"
                    objSQLCmd.Parameters("prmMB0_UPDATE_USR").Value = User.Identity.Name
                ...
                Case "DELETE"
                    Select Case Master.ppBtnDelete.Text
                        Case "削除"
                            ...
                            objSQLCmd.Parameters("prmMB0_DELETE_FLG").Value = "1"
                            objSQLCmd.Parameters("prmMB0_UPDATE_USR").Value = User.Identity.Name
...
'                    mstrDispMode = "UPD"
                ...
                '    objSQLCmd.Connection = mclsDB.mobjDB
                '    objSQLCmd.CommandText = "COMUPDMB0_S4"
                '    objSQLCmd.Parameters.Add("prmMB0_APPACLASS_CD", SqlDbType.NVarChar)
                '    objSQLCmd.Parameters.Add("prmMB0_APPA_CLS", SqlDbType.NVarChar)
...
'                mstrDispMode = "UPD"
    ...
    Private Sub sSetddlAPPACLASS()
        ...
        objSQLCmd.Connection = mclsDB.mobjDB
        objSQLCmd.CommandText = "COMUPDMB0_S2"
        If mclsDB.pfGet_DataSet(objSQLCmd, objwkDS) = False Then
            'エラー
            clsMst.psMesBox(Me, "10001", ClsComVer.E_Mタイプ.エラー, ClsComVer.E_S実行.描画後, "リスト作成")
            objStack = New StackFrame
    ...
    Private Sub sSetddlSEARIAL_CLS()
        ...
        objSQLCmd.Connection = mclsDB.mobjDB
        objSQLCmd.CommandText = "COMUPDMB0_S3"
        If mclsDB.pfGet_DataSet(objSQLCmd, objwkDS) = False Then
            'エラー
            clsMst.psMesBox(Me, "10001", ClsComVer.E_Mタイプ.エラー, ClsComVer.E_S実行.描画後, "リスト作成")
            objStack = New StackFrame
