'更新　2016.11.17 伯野　同期ボタン作成のためオブジェクトbtnGeneralを追加
...
Public Class MstMaster
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            btnDelete.OnClientClick = pfGet_OCClickMes("00005", ClsComVer.E_Mタイプ.情報, ClsComVer.E_Mモード.OKCancel, lblTitle.Text)       '削除
        End If
    End Sub
    ...
    Public ReadOnly Property ppbtnGeneral() As Button
        Get
            Return btnGeneral
        End Get
    End Property
