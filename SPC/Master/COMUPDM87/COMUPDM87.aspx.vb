...
#Region "定数定義"
    ...
    '============================================================================================================================
    '画面情報
    Const DispCode As String = "COMUPDM87"                   '画面ID

    'マスタ情報
    Const MasterName1 As String = "MDN機種マスタ"            'マスタ名
    Const TableName1 As String = "M87_MDN_APPA"            'テーブル名
...
#Region "イベントプロシージャ"
    ...
    Private Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        AddHandler txtAppaCd.TextChanged, AddressOf txtAppaCd_TextChanged
        txtAppaCd.AutoPostBack = True
    ...
    Private Sub grvList_RowCommand(sender As Object, e As CommandEventArgs) Handles grvList.RowCommand
        ...
        Try
            ...
            If e.CommandName = "Select" Then
                ...
                'ロックテーブルキー項目の登録
                arKey.Insert(0, CType(rowData.FindControl("機種コード"), TextBox).Text)
                ...
                '登録エリアに値を入力
                txtAppaCd.Text = CType(rowData.FindControl("機種コード"), TextBox).Text
                txtAppaNm.ppText = CType(rowData.FindControl("機種名称"), TextBox).Text

                'フォーカスをtxtAppaNmへ
                SetFocus(txtAppaNm.ppTextBox.ClientID)
...
#Region "そのほかのプロシージャ"
        ...
        If clsDataConnect.pfOpen_Database(conDB) Then
            Try
                ...
                With cmdDB.Parameters
                    ...
                    .Add(pfSet_Param("Progid", SqlDbType.NVarChar, Master.ppProgramID))
                End With
            ...
            Try
                ...
                Select Case ipstrMode
                    Case "INSERT", "UPDATE"      '登録/更新
                        ...
                        With cmdDB.Parameters
                            'データグリッドパラメータ設定
                            .Add(pfSet_Param("Appa_Cd", SqlDbType.NVarChar, Me.txtAppaCd.Text))
                            .Add(pfSet_Param("Appa_Nm", SqlDbType.NVarChar, Me.txtAppaNm.ppText))
        ...
        If (Page.IsValid) Then
            ...
            If clsDataConnect.pfOpen_Database(conDB) Then
                Try
                    ...
                    edit_num(txtAppaCd.Text)

                    cmdDB = New SqlCommand(DispCode & "_S1", conDB)
                    With cmdDB.Parameters
                        'データグリッドパラメータ設定
                        .Add(pfSet_Param("Appa_Cd", SqlDbType.NVarChar, txtAppaCd.Text.ToString))
                        .Add(pfSet_Param("SearchCls", SqlDbType.NVarChar, "1"))
                        .Add(pfSet_Param("Progid", SqlDbType.NVarChar, DispCode))
                    End With
                    ...
                    If dstOrders.Tables(0).Rows.Count > 0 Then
                        ...
                        'ロックテーブルキー項目の登録
                        arKey.Insert(0, dstOrders.Tables(0).Rows(0).Item("機種コード"))
                        ...
                        '登録エリアに値を入力
                        txtAppaCd.Text = dstOrders.Tables(0).Rows(0).Item("機種コード")
                        txtAppaNm.ppText = dstOrders.Tables(0).Rows(0).Item("機種名称")
    ...
    Private Sub cuvSyscode_ServerValidate(source As Object, args As ServerValidateEventArgs) Handles CstAppaCd.ServerValidate
        ...
        If txtAppaCd.Enabled = False Then
            args.IsValid = True
            Exit Sub
        End If
        ...
        ElseIf tb.Text <> "0" AndAlso tb.Text <> "０" Then
            txtAppaCd.Text = edit_num(tb.Text)
        End If

        If txtAppaCd.Text.Length = 1 Then
