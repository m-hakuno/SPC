<%@ Page Title="" Language="VB" MasterPageFile="~/Master/Mst.Master" AutoEventWireup="false" CodeBehind="COMUPDM70.aspx.vb" Inherits="SPC.COMUPDM70" %>
...
<asp:Content ID="serchcontent" ContentPlaceHolderID="SearchContent" runat="server">
    <table style="width: 700px; margin-left: auto; margin-right: auto; border: none; text-align: left;">
        <tr>
            <td style="float: left;">
                <uc:ClsCMDropDownList ID="ddlSDisp" runat="server" ppName="画面区分" ppNameWidth="60" ppWidth="150" ppClassCD="0119" ppNotSelect="true" />
            </td>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width: 700px; margin-right: auto; margin-left: auto; border: none; text-align: left;">
        <tr>
            <td style="float: left;">
                <uc:ClsCMDropDownList ID="ddlMDisp" runat="server" ppName="画面区分" ppNameWidth="60" ppWidth="150" ppClassCD="0119" ppNotSelect="true" />
            </td>
            <td style="float: left;margin-left:30px;">
                <table>
                    <tr>
