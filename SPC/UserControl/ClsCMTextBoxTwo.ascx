<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ClsCMTextBoxTwo.ascx.vb" Inherits="SPC.ClsCMTextBoxTwo" %>
        ...
        <tr style="vertical-align: top">
            ...
            <td>
                <asp:Panel ID="pnlData" runat="server">
                    ...
                    <asp:TextBox ID="txtTextBoxTwo" runat="server"></asp:TextBox>
