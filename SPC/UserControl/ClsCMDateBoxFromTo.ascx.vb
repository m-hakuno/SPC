...
Public Class ClsCMDateBoxFromTo
#Region "継承定義"
    '============================================================================================================================
    '=　継承定義
    '============================================================================================================================
...
#Region "プロパティ定義"
    ...
    Public Property ppFromText() As String
        Get
            Return txtDateBoxFrom.Text
        End Get
        Set(ByVal value As String)
            txtDateBoxFrom.Text = value
        End Set
    End Property

    'From日付
    Public Property ppFromDate() As Date
        Get
            If DateTime.TryParse(txtDateBoxFrom.Text, Nothing) Then
                Return Date.Parse(txtDateBoxFrom.Text)
            Else
                Return Nothing
            End If
        End Get
        Set(ByVal value As Date)
            Select Case mdafDataFormat
                Case ClsComVer.E_日付形式.年月日
                    txtDateBoxFrom.Text = value.ToString("yyyy/MM/dd")
                Case ClsComVer.E_日付形式.年月
                    txtDateBoxFrom.Text = value.ToString("yyyy/MM")
            End Select
        End Set
    End Property
    ...
    Public Property ppToText() As String
        Get
            Return txtDateBoxTo.Text
        End Get
        Set(ByVal value As String)
            txtDateBoxTo.Text = value
        End Set
    End Property

    'To日付
    Public Property ppToDate() As Date
        Get
            If DateTime.TryParse(txtDateBoxTo.Text, Nothing) Then
                Return Date.Parse(txtDateBoxTo.Text)
            Else
                Return Nothing
            End If
        End Get
        Set(ByVal value As Date)
            Select Case mdafDataFormat
                Case ClsComVer.E_日付形式.年月日
                    txtDateBoxTo.Text = value.ToString("yyyy/MM/dd")
                Case ClsComVer.E_日付形式.年月
                    txtDateBoxTo.Text = value.ToString("yyyy/MM")
            End Select
        End Set
    End Property
    ...
    Public Property ppDateFormat() As ClsComVer.E_日付形式
        ...
        Set(ByVal value As ClsComVer.E_日付形式)
            ...
            Select Case mdafDataFormat
                Case ClsComVer.E_日付形式.年月
                    txtDateBoxFrom_CalendarExtender.Format = "yyyy/MM"
                    txtDateBoxFrom.MaxLength = 7
                    txtDateBoxFrom.Width = 48
                    txtDateBoxTo_CalendarExtender.Format = "yyyy/MM"
                    txtDateBoxTo.MaxLength = 7
                    txtDateBoxTo.Width = 48
                Case ClsComVer.E_日付形式.年月日
                    txtDateBoxFrom_CalendarExtender.Format = "yyyy/MM/dd"
                    txtDateBoxFrom.MaxLength = 10
                    txtDateBoxFrom.Width = 67
                    txtDateBoxTo_CalendarExtender.Format = "yyyy/MM/dd"
                    txtDateBoxTo.MaxLength = 10
                    txtDateBoxTo.Width = 67
            End Select
        End Set
    End Property
    ...
    Public Property ppTabIndex() As Short
        Get
            Return txtDateBoxFrom.TabIndex
        End Get
        Set(ByVal value As Short)
            txtDateBoxFrom.TabIndex = value
            txtDateBoxTo.TabIndex = Short.Parse((value + 1).ToString)
        End Set
    End Property
    ...
    Public Property ppFontSize() As FontUnit
        ...
        Set(ByVal value As FontUnit)
            ...
            lblFromTo.Font.Size = mintFontSize
            txtDateBoxFrom.Font.Size = mintFontSize
            txtDateBoxTo.Font.Size = mintFontSize
            txtDateBoxFrom.Width = (Decimal.Parse(mintFontSize.ToString.Replace("pt", "")) / 3) * 21
            txtDateBoxTo.Width = (Decimal.Parse(mintFontSize.ToString.Replace("pt", "")) / 3) * 21
        End Set
    End Property

    'DateBoxFrom
    Public ReadOnly Property ppDateBoxFrom() As TextBox
        Get
            Return txtDateBoxFrom
        End Get
    End Property

    'DateBoxTo
    Public ReadOnly Property ppDateBoxTo() As TextBox
        Get
            Return txtDateBoxTo
        End Get
    End Property
...
#Region "イベントプロシージャ"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Select Case mdafDataFormat
            Case ClsComVer.E_日付形式.年月
                txtDateBoxFrom.Attributes.Add("onBlur", "setDateM(this)")
                txtDateBoxTo.Attributes.Add("onBlur", "setDateM(this)")
            Case ClsComVer.E_日付形式.年月日
                txtDateBoxFrom.Attributes.Add("onBlur", "isDate(this)")
                txtDateBoxTo.Attributes.Add("onBlur", "isDate(this)")
        End Select
        '-----------------------------
        '2014/04/23 土岐　ここまで
        '-----------------------------
    ...
    Protected Sub cuvDateBox_ServerValidate(source As Object, args As ServerValidateEventArgs) Handles cuvDateBox.ServerValidate
        ...
        If pnlCtrl.Enabled = True Then
            ...
            If DateTime.TryParse(txtDateBoxFrom.Text, dttDate) Then
                Select Case mdafDataFormat
                    Case ClsComVer.E_日付形式.年月
                        txtDateBoxFrom.Text = dttDate.ToString("yyyy/MM")
                    Case ClsComVer.E_日付形式.年月日
                        txtDateBoxFrom.Text = dttDate.ToString("yyyy/MM/dd")
                End Select
            End If
            '-----------------------------
            '2014/04/23 土岐　ここまで
            '-----------------------------
            'Fromチェック
            strErrNo = ClsCMCommon.pfCheck_DateErr(txtDateBoxFrom.Text, False, mdafDataFormat)
            ...
            '2014/04/23 土岐　ここから
            '-----------------------------
            If DateTime.TryParse(txtDateBoxTo.Text, dttDate) Then
                Select Case mdafDataFormat
                    Case ClsComVer.E_日付形式.年月
                        txtDateBoxTo.Text = dttDate.ToString("yyyy/MM")
                    Case ClsComVer.E_日付形式.年月日
                        txtDateBoxTo.Text = dttDate.ToString("yyyy/MM/dd")
                End Select
            End If
            '-----------------------------
            '2014/04/23 土岐　ここまで
            '-----------------------------
            'Toチェック
            strErrNo = ClsCMCommon.pfCheck_DateErr(txtDateBoxTo.Text, False, mdafDataFormat)
            ...
            If strErrNo <> String.Empty Then
                ...
                Select Case strErrNo
                    ...
                    Case Else
                        'エラー
                        psSet_ErrorNo(strErrNo, lblName.Text, "日付")
                        args.IsValid = cuvDateBox.IsValid
                        Exit Sub
                End Select
            ...
            'FromToチェック
            strErrNo = ClsCMCommon.pfCheck_DateFTErr(txtDateBoxFrom.Text, txtDateBoxTo.Text, mblnReqFieldVal)
