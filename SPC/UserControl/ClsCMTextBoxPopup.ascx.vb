...
Public Class ClsCMTextBoxPopup
...
#Region "プロパティ定義"
    ...
    '取得する条件
    Private mstrKyeCode() As String
    Public Property ppKeyCode() As String()
        Get
            Return mstrKyeCode
        End Get
    ...
    '表示する項目の条件
    Private Const mstrShowCodeDef = "0"
    Private mstrShowCodeVal As String = mstrShowCodeDef
    <DefaultValue(mstrShowCodeDef)> _
    Public Property ppShowCode As String
        Get
            Return mstrShowCodeVal
        End Get
        Set(ByVal value As String)
            mstrShowCodeVal = value
        End Set
    End Property
    ...
    '文字縦幅
    Public Property ppHeight() As Unit
        Get
            Return txtTextBox.Height
        End Get
        Set(ByVal value As Unit)
...
#Region "イベントプロシージャ"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'ボタンアクションの設定
        AddHandler ClsCMpnlPopup.DialogClosed, AddressOf ModalPopupSample_DialogClosed
        If Not IsPostBack Then  '初回表示
            Dim scriptText As String = ""
            Me.txtTextBox.Attributes.Add("onKeyDown", "convertEnterToTab(event)")
            ViewState(P_KEY) = ppKeyCode
        End If
    End Sub
...
#Region "そのほかのプロシージャ"
    ...
    Private Sub btnRef_Click(sender As Object, e As EventArgs) Handles btnRef.Click
        ...
        '表示区分 0:社員名 1:業者情報
        Dim showKbn As String = ppShowCode

        'ポップアップ画面の表示 
        ClsCMpnlPopup.Show(ViewState(P_KEY), showKbn)
    ...
    ''' </summary>
    ''' <remarks></remarks>   
    Private Sub ModalPopupSample_DialogClosed(arg As ClsCMpnlPopup.ClosedEventArgs)
        'ポップアップ画面を閉じたとき
        If Not arg.strSearch = "" Then
            Me.txtTextBox.Text = arg.strSearch
        End If
        Me.txtTextBox.Focus()
