...
Public Class ClsCMTextBoxFromTo
#Region "継承定義"
    '============================================================================================================================
    '=　継承定義
    '============================================================================================================================
...
#Region "プロパティ定義"
    ...
    Public Property ppFontSize() As FontUnit
        ...
        Set(ByVal value As FontUnit)
            ...
            txtTextBoxFrom.Font.Size = mintFontSize
            txtTextBoxTo.Font.Size = mintFontSize
        End Set
    End Property
    ...
    Public Property ppTabIndex() As Short
        ...
        Set(ByVal value As Short)
            ...
            txtTextBoxTo.TabIndex = Short.Parse((value + 1).ToString)
        End Set
    End Property

    'TextBoxFrom
    Public ReadOnly Property ppTextBoxFrom() As TextBox
        Get
    ...
    'TextBoxTo
    Public ReadOnly Property ppTextBoxTo() As TextBox
        Get
            Return txtTextBoxTo
        End Get
    End Property
    ...
    Protected Sub cuvTextBox_ServerValidate(source As Object, args As ServerValidateEventArgs) Handles cuvTextBox.ServerValidate
        If pnlCtrl.Enabled = True Then
            ...
            If strErrNo <> String.Empty Then
                ...
                Else
                    psSet_ErrorNo(strErrNo, lblName.Text, txtTextBoxFrom.MaxLength.ToString)
                End If
            ...
            If strErrNo <> String.Empty Then
                ...
                If strErrNo = "4001" Then
                    psSet_ErrorNo(strErrNo, lblName.Text, "正しい形式")
                Else
                    psSet_ErrorNo(strErrNo, lblName.Text, txtTextBoxTo.MaxLength.ToString)
                End If
                args.IsValid = cuvTextBox.IsValid
                Exit Sub
            End If
            ...
            'FromToチェック
            strErrNo = ClsCMCommon.pfCheck_TxtFTErr(txtTextBoxFrom.Text, txtTextBoxTo.Text, mblnReqFieldVal)
