...
#Region "プロパティ定義"
    ...
    '============================================================================================================================
    'テキスト1
    Public Property ppTextOne() As String
        Get
    ...
    'テキスト2
    Public Property ppTextTwo() As String
        Get
            Return txtTextBoxTwo.Text
        End Get
        Set(ByVal value As String)
            txtTextBoxTwo.Text = value
        End Set
    End Property
    ...
    Public Property ppText() As String
        Get
            Return txtTextBox.Text & txtTextBoxTwo.Text
        End Get
        Set(ByVal value As String)
            If value.Length >= 0 Then
                If value.Length >= txtTextBox.MaxLength Then
                    txtTextBox.Text = value.Substring(0, txtTextBox.MaxLength)
                Else
                    txtTextBox.Text = value
                End If
            Else
            ...
            End If
            If value.Length >= txtTextBox.MaxLength Then
                txtTextBoxTwo.Text = value.Substring(txtTextBox.MaxLength)
            Else
                txtTextBoxTwo.Text = String.Empty
            End If
        End Set
    End Property
    ...
    Public Property ppTextModeTwo() As TextBoxMode
        Get
            Return txtTextBoxTwo.TextMode
        End Get
        Set(ByVal value As TextBoxMode)
            txtTextBoxTwo.TextMode = value
        End Set
    End Property
    ...
    Public Property ppMaxLengthTwo() As Integer
        Get
            Return txtTextBoxTwo.MaxLength
        End Get
        Set(ByVal value As Integer)
            txtTextBoxTwo.MaxLength = value
        End Set
    End Property
    ...
    Public Property ppWidthTwo() As Unit
        Get
            Return txtTextBoxTwo.Width
        End Get
        Set(ByVal value As Unit)
            txtTextBoxTwo.Width = value
        End Set
    End Property
    ...
    Public Property ppTabIndex() As Short
        ...
        Set(ByVal value As Short)
            ...
            txtTextBoxTwo.TabIndex = Short.Parse((value + 1).ToString)
        End Set
    End Property

    'TextBoxOne
    Public ReadOnly Property ppTextBoxOne() As TextBox
        Get
            Return txtTextBox
        End Get
    End Property
    ...
    Public ReadOnly Property ppTextBoxTwo() As TextBox
        Get
            Return txtTextBoxTwo
        End Get
    End Property

    'IMEモード
    Private mshtIMEModeOne As ClsComVer.E_IMEモード
    Public Property ppIMEModeOne As ClsComVer.E_IMEモード
        Get
            Return mshtIMEModeOne
        End Get
        Set(ByVal value As ClsComVer.E_IMEモード)
            mshtIMEModeOne = value
            Select Case mshtIMEModeOne
    ...
    Public Property ppIMEModeTwo As ClsComVer.E_IMEモード
        ...
        Set(ByVal value As ClsComVer.E_IMEモード)
            ...
            Select Case mshtIMEModeTwo
                Case ClsComVer.E_IMEモード.全角
                    txtTextBoxTwo.CssClass = P_CSS_ZEN
                Case ClsComVer.E_IMEモード.半角_変更可
                    txtTextBoxTwo.CssClass = P_CSS_HAN_COK
                Case ClsComVer.E_IMEモード.半角_変更不可
                    txtTextBoxTwo.CssClass = P_CSS_HAN_CNG
            End Select
        End Set
    End Property
    ...
    Public Property ppTextAlignTwo As ClsComVer.E_文字位置
        ...
        Set(value As ClsComVer.E_文字位置)
            ...
            Select Case mshtTextAlignTwo
                Case ClsComVer.E_文字位置.右
                    txtTextBoxTwo.Style.Item(HtmlTextWriterStyle.TextAlign) = "Right"
                Case ClsComVer.E_文字位置.左
                    txtTextBoxTwo.Style.Item(HtmlTextWriterStyle.TextAlign) = "left"
                Case ClsComVer.E_文字位置.中央
                    txtTextBoxTwo.Style.Item(HtmlTextWriterStyle.TextAlign) = "Center"
            End Select
        End Set
    End Property
#End Region
...
#Region "イベントプロシージャ"
    ...
    Protected Sub cuvTextBox_ServerValidate(source As Object, args As ServerValidateEventArgs) Handles cuvTextBox.ServerValidate
        If pnlCtrl.Enabled = True Then
            ...
            args.IsValid = True
            strMaxLength = (txtTextBox.MaxLength + txtTextBoxTwo.MaxLength).ToString
            'TextBox1チェック
            strErrNo = ClsCMCommon.pfCheck_TxtErr(txtTextBox.Text,
                                                   mblnReqFieldVal,
                                                   mblnNumFOne,
                                                   mblnCheckHanOne,
                                                   mblnCheckLengthOne,
            ...
            'TextBox2チェック
            strErrNo = ClsCMCommon.pfCheck_TxtErr(txtTextBoxTwo.Text,
                                                   mblnReqFieldVal,
                                                   mblnNumFTwo,
                                                   mblnCheckHanTwo,
                                                   mblnCheckLengthTwo,
                                                   txtTextBoxTwo.MaxLength,
                                                   mstrExpressionTwo,
                                                   mblnCheckAcTwo)
