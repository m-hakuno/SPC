...
Public Class COMMENP010
    ...
    '============================================================================================================================
    '物品転送依頼書 参照／更新 画面のパス
    Private Const M_COMMENP010 As String = "~/" & P_COM & "/" & P_FUN_COM & P_SCR_MEN & P_PAGE & "010" & "/" & P_FUN_COM & P_SCR_MEN & P_PAGE & "010.aspx"
    Private Const M_DISP_ID = P_FUN_COM & P_SCR_MEN & P_PAGE & "010"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        pfSet_GridView(Me.grvList, "COMMENP010", "L")
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        ...
        psLogWrite("", Me.User.Identity.Name, objStack.GetMethod.DeclaringType.Name,
                        objStack.GetMethod.Name, M_COMMENP010, strPrm, "TRANS")
        '■□■□結合試験時のみ使用予定□■□■
        '--------------------------------
        '2014/04/16 星野　ここまで
        '--------------------------------
        psOpen_Window(Me, M_COMMENP010)
        'ログ出力終了
        psLogEnd(Me)
    End Sub
