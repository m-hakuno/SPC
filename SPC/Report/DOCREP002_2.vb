...
Public Class DOCREP002_2


    Private Sub DOCREP002_2_ReportStart(sender As Object, e As EventArgs) Handles Me.ReportStart

        TxtFAILPRI.DataField = Nothing
        TxtFAILPRI.Text = ""
        TxtFAILNO.DataField = Nothing
        TxtFAILNO.Text = ""
        TxtFAIL_TTL.DataField = Nothing
        TxtFAIL_TTL.Text = ""
        TextBox10.DataField = Nothing
        TextBox10.Text = ""
        TxtPRICE.DataField = Nothing
        TxtPRICE.Text = ""
