...
Public Class MSTREP001
    ...
    Private Sub Detail1_Format(sender As Object, e As EventArgs) Handles Detail1.Format
        ...
        If Me.Fields("送付先１郵便番号").Value.ToString = "" _
                ...
                AndAlso Me.Fields("送付先１名称").Value.ToString = "" _
                AndAlso Me.Fields("送付先１気付").Value.ToString = "" _
                AndAlso Me.Fields("送付先１電話番号").Value.ToString = "" _
                AndAlso Me.Fields("送付先１FAX番号").Value.ToString = "" _
        ...
        If Me.Fields("送付先２郵便番号").Value.ToString = "" _
                ...
                AndAlso Me.Fields("送付先２名称").Value.ToString = "" _
                AndAlso Me.Fields("送付先２気付").Value.ToString = "" _
                AndAlso Me.Fields("送付先２電話番号").Value.ToString = "" _
                AndAlso Me.Fields("送付先２FAX番号").Value.ToString = "" _
        ...
        If Me.Fields("送付先３郵便番号").Value.ToString = "" _
                ...
                AndAlso Me.Fields("送付先３名称").Value.ToString = "" _
                AndAlso Me.Fields("送付先３気付").Value.ToString = "" _
                AndAlso Me.Fields("送付先３電話番号").Value.ToString = "" _
                AndAlso Me.Fields("送付先３FAX番号").Value.ToString = "" _
